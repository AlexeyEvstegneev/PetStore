					...
					<div className='footer__wrapper'>
						<div className='footer__col'>
							<span
								...
								aria-hidden='true'>
								<img
									src='/images/logo.4f9d699de55eb25e196ecc4c87a15a5e.svg'
							...
							<div className='contacts'>
								...
								<ul className='socials contacts__socials'>
									...
									<li className='socials__item'>
										<a className='socials__link' href='/#'>
											<img
												src='/Users/aleksejevstegneev/Downloads/HomeWork/PetStore/src/components/images/whatsapp.51cbd71440eaa90946070b8848c12129.svg'
												alt='whatsapp'
												className='socials__icon'
											/>
										</a>
